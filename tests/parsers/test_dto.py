"""Генеративные тесты для VacancyDTO с использованием Hypothesis."""
...
def test_salary_normalization_does_not_crash(salary_str: str | None) -> None:
    """Проверяет, что нормализация зарплаты обрабатывает входные данные без сбоев.

    Args:
        salary_str: Строка, сгенерированная Hypothesis на основе стратегии.
    """
